...
<div class="col-md-6 chit-chat-layer1-left">
	<div class="work-progres">
		...
		<% 
				...
				String query ="SELECT equipment.eid, equipment.ename, admin.aname,equipment.ehourprice,equipment.edayprice, equipment.edeposite,admin.aid , equipment.ecategary FROM equipment JOIN admin ON equipment.aid = admin.aid where eid=?";
		...
		%>
				 ...
				 <div class="table-responsive">
				   ...
				   <% if(categary != null && categary.equalsIgnoreCase("fertilizer")) { %>
				    ...
				    <tr>
				     ...
				     <form action="Conferm" method="post">
				     	...
				     	<% if(categary != null && categary.equalsIgnoreCase("fertilizer")) { %>
				     		...
				     		<input type="hidden" name="totalamount" value="<%= pri + gst%>">
				     	<% } else { %>
					   ...
					   <td>
					   		<button type="submit" class="btn btn-primary">Conferm</button>
					   </td>
				     </form>
